...
function passVal() {
    ...
    (pwd === "") ? (errorMsg.innerHTML = "Password is required", tick.style.display = "none", pwdInput.style.border = "1px solid red" ) : (tick.style.display = "block", errorMsg.style.display = "none", pwdInput.style.border = "");
}
