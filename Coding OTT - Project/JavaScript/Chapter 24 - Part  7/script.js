...
function conPassVal() {
    ...
    (conPwd === "") ? (errorMsg.innerHTML = "Confirm Password is required", conPwdInput.style.border = "1px solid red") : (pwd === conPwd) ? (btn.disabled = false, btn.style.cursor = "pointer", btn.style.backgroundColor = "#0004d5", tick.style.display = "block", errorMsg.style.display = "none", conPwdInput.style.border = "") : (btn.disabled = true, btn.style.cursor = "not-allowed", btn.style.backgroundColor = "#007bff", errorMsg.innerHTML = "Confirm password is not match", tick.style.display = "none", conPwdInput.style.border = "1px solid red");
}
...
function emailVal() {
    ...
    (email === "") ? (errorMsg.innerHTML = "Email is required", tick.style.display = "none", emailInput.style.border = "1px solid red", box.style.display = "none") : email.match('@') ? (email.match("gmail.com") || email.match("yahoomail.com") || email.match("zohomail.in")) ? (tick.style.display = "block", box.style.display = "none", errorMsg.style.display = "none", emailInput.style.border = "") : (tick.style.display = "none", box.style.display = "block", errorMsg.style.display = "block", emailInput.style.border = "1px solid red") : (errorMsg.innerHTML = "Enter valid email", tick.style.display = "none", box.style.display = "none", errorMsg.style.display = "block", emailInput.style.border = "1px solid red");
