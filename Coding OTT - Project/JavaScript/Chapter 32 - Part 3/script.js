...
let obj = { firstName: "", lastName: "", emailId: "", mobileNumber: "", userNames: "", pass: "", confirmPass: "" };
...
function allData() {
    ...
    if (fName.trim() === "" || lName.trim() === "" || mNum.trim() === "" || uName.trim() === "" || pwd.trim() === "" || conPwd.trim() === "" || email.trim() === "") {
        ...
        console.log(obj);
        window.alert("Check Console Message");
        return false;
    }
